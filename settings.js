...
module.exports = {
  /*
   ** Config parameters not used in embedded mode
   **
   ** uiHost: '127.0.0.1',
  ...
  adminAuth: {
    ...
    users: [
      {
        // To generate a password: yarn create-auth-password -- <password>
        // Default username & password: admin / admin
        // For more information see http://nodered.org/docs/security.html#generating-the-password-hash
        username: 'admin',
        password: '$2a$08$lOdTy91RBpeU3d.QrrmxSueP51Ug2XOgC90YlEKSQE3Gtv6y4F76m',
